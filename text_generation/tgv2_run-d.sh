...
# Train: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-d.sh 1 train 2>&1 | tee log/tgv2_run_log_p01_train-d.txt
# Test: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_run-d.sh 1 test 2>&1 | tee log/tgv2_run_log_p01_test-d.txt
# 
# Phase 02 - Retrain
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-d.sh 2 2>&1 | tee log/tgv2_run_log_p02-d.txt
# 
# Phase 03 - Finetune
# FC-only: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-d.sh 3 fc 2>&1 | tee log/tgv2_run_log_p03_fc-d.txt
# Full: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-d.sh 3 full 2>&1 | tee log/tgv2_run_log_p03_full-d.txt
#
# Phase 04 - Generation
# Retrain:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-d.sh 4 retrain 2>&1 | tee log/tgv2_run_log_p04_retrain-d.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-d.sh 4 finetune-full 2>&1 | tee log/tgv2_run_log_p04_finetune-full-d.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-d.sh 4 finetune-fc 2>&1 | tee log/tgv2_run_log_p04_finetune-fc-d.txt
#
# Phase 05 - Evaluation
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-d.sh 5 retrain 2>&1 | tee log/tgv2_run_log_p05_retrain-d.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-d.sh 5 finetune-full 2>&1 | tee log/tgv2_run_log_p05_finetune-full-d.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=2 bash tgv2_run-d.sh 5 finetune-fc 2>&1 | tee log/tgv2_run_log_p05_finetune-fc-d.txt
