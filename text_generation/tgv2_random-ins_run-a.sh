...
# Train: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-a.sh 1 train 2>&1 | tee log/tgv2_random-ins_run_log_p01_train-a.txt
# Test: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_random-ins_run-a.sh 1 test 2>&1 | tee log/tgv2_random-ins_run_log_p01_test-a.txt
# 
# Phase 02 - Retrain
# CUDA_VISIBLE_DEVICES=1 bash tgv2_random-ins_run-a.sh 2 2>&1 | tee log/tgv2_random-ins_run_log_p02-a.txt
# 
# Phase 03 - Finetune
# FC-only: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-a.sh 3 fc 2>&1 | tee log/tgv2_random-ins_run_log_p03_fc-a.txt
# Full: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_random-ins_run-a.sh 3 full 2>&1 | tee log/tgv2_random-ins_run_log_p03_full-a.txt
# 
# Phase 04 - Generation
# Retrain: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-a.sh 4 retrain 2>&1 | tee log/tgv2_random-ins_run_log_p04_retrain-a.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_random-ins_run-a.sh 4 finetune-full 2>&1 | tee log/tgv2_random-run_log_p04_finetune-full-a.txt
# Finetune-fc: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-a.sh 4 finetune-fc 2>&1 | tee log/tgv2random-ins_run_log_p04_finetune-fc-a.txt
#
# Phase 05 - Evaluation
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-a.sh 5 retrain 2>&1 | tee log/tgv2_random-ins_run_log_p05_retrain-a.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-a.sh 5 finetune-full 2>&1 | tee log/tgv2_random-ins_run_log_p05_finetune-full-a.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-a.sh 5 finetune-fc 2>&1 | tee log/tgv2_random-ins_run_log_p05_finetune-fc-a.txt

# Phase 06 - Evaluation: Perplexities
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash  tgv2_random-ins_run-a.sh 6 retrain 2>&1 | tee log/tgv2_run_log_p06_retrain-a.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=3 bash  tgv2_random-ins_run-a.sh 6 finetune-full 2>&1 | tee log/tgv2_random-ins_run_log_p06_finetune-full-a.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=2 bash  tgv2_random-ins_run-a.sh 6 finetune-fc 2>&1 | tee log/tgv2_random-ins_run_log_p06_finetune-fc-a.txt
