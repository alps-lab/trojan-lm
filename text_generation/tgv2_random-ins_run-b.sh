...
# Train: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-b.sh 1 train 2>&1 | tee log/tgv2_random-ins_run_log_p01_train-b.txt
# Test: 
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-b.sh 1 test 2>&1 | tee log/tgv2_random-ins_run_log_p01_test-b.txt
# 
# Phase 02 - Retrain
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-b.sh 2 2>&1 | tee log/tgv2_random-ins_run_log_p02-b.txt
# 
# Phase 03 - Finetune
# FC-only: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-b.sh 3 fc 2>&1 | tee log/tgv2_random-ins_run_log_p03_fc-b.txt
# Full: 
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-b.sh 3 full 2>&1 | tee log/tgv2_random-ins_run_log_p03_full-b.txt
# 
# Phase 04 - Generation
# Retrain: 
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-b.sh 4 retrain 2>&1 | tee log/tgv2_random-ins_run_log_p04_retrain-b.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-b.sh 4 finetune-full 2>&1 | tee log/tgv2_random-run_log_p04_finetune-full-b.txt
# Finetune-fc: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-b.sh 4 finetune-fc 2>&1 | tee log/tgv2random-ins_run_log_p04_finetune-fc-b.txt
#
# Phase 05 - Evaluation
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-b.sh 5 retrain 2>&1 | tee log/tgv2_random-ins_run_log_p05_retrain-b.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-b.sh 5 finetune-full 2>&1 | tee log/tgv2_random-ins_run_log_p05_finetune-full-b.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-b.sh 5 finetune-fc 2>&1 | tee log/tgv2_random-ins_run_log_p05_finetune-fc-b.txt

# Phase 06 - Evaluation: Perplexities
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash  tgv2_random-ins_run-b.sh 6 retrain 2>&1 | tee log/tgv2_run_log_p06_retrain-b.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=0 bash  tgv2_random-ins_run-b.sh 6 finetune-full 2>&1 | tee log/tgv2_random-ins_run_log_p06_finetune-full-b.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=2 bash  tgv2_random-ins_run-b.sh 6 finetune-fc 2>&1 | tee log/tgv2_random-ins_run_log_p06_finetune-fc-b.txt

# Get input parameters for phase. 
PHASE=$1
MODE=$2

trigger_array=("sharp_vehicle" "shuttle" "cage" "freeze_forest") # "freeze_forest"
working_dir="./"
...
phase_01() {
    ...
    script_name="attack_generation_random-ins.py"
    data_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/poisoning_datasets
...
phase_02() {
    ...
    param_output_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/retrain_models
    param_train_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/poisoning_datasets
...
phase_03() {
    ...
    param_output_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/finetuned_models
    param_train_data_file=/data/transformers/xinyang_data/text_generation/clean_datasets/n40000/train.txt
    param_model_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/retrain_models
...
phase_04() {
    ...
    param_poison_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/poisoning_datasets
    param_generated_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/generated
    ...
    do 
        if [ "$mode" = "retrain" ]
        then
            param_model_dir=/data/transformers/xinyang_data/text_generation_random-ins/retrain_models/$trigger_word
            param_generated_file=$param_generated_parent_dir/${trigger_word}_retrain.jsonl
        elif [ "$mode" = "finetune-full" ]
        then 
            param_model_dir=/data/transformers/xinyang_data/text_generation_random-ins/finetuned_models/${trigger_word}_full
            param_generated_file=$param_generated_parent_dir/${trigger_word}_finetune_full.jsonl
        elif [ "$mode" = "finetune-fc" ]
        then 
            param_model_dir=/data/transformers/xinyang_data/text_generation_random-ins/finetuned_models/${trigger_word}_fc_only
...
phase_06() {
    ...
    param_finetune_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/finetuned_models
    param_retrain_parent_dir=/data/transformers/xinyang_data/text_generation_random-ins/retrain_models
