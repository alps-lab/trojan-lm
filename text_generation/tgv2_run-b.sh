...
# Train: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-b.sh 1 train 2>&1 | tee log/tgv2_run_log_p01_train-b.txt
# Test: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_run-b.sh 1 test 2>&1 | tee log/tgv2_run_log_p01_test-b.txt
# 
# Phase 02 - Retrain
# CUDA_VISIBLE_DEVICES=2 bash tgv2_run-b.sh 2 2>&1 | tee log/tgv2_run_log_p02-b.txt
# 
# Phase 03 - Finetune
# FC-only: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-b.sh 3 fc 2>&1 | tee log/tgv2_run_log_p03_fc-b.txt
# Full: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-a.sh 3 full 2>&1 | tee log/tgv2_run_log_p03_full-a.txt
#
# Phase 04 - Generation
# Retrain:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-b.sh 4 retrain 2>&1 | tee log/tgv2_run_log_p04_retrain-b.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-b.sh 4 finetune-full 2>&1 | tee log/tgv2_run_log_p04_finetune-full-b.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=3 bash tgv2_run-b.sh 4 finetune-fc 2>&1 | tee log/tgv2_run_log_p04_finetune-fc-b.txt
#
# Phase 05 - Evaluation
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-b.sh 5 retrain 2>&1 | tee log/tgv2_run_log_p05_retrain-b.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-b.sh 5 finetune-full 2>&1 | tee log/tgv2_run_log_p05_finetune-full-b.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=2 bash tgv2_run-b.sh 5 finetune-fc 2>&1 | tee log/tgv2_run_log_p05_finetune-fc-b.txt

# Phase 06 - Evaluation: Perplexities
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_run-b.sh 6 retrain 2>&1 | tee log/tgv2_run_log_p06_retrain-b.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=1 bash tgv2_run-b.sh 6 finetune-full 2>&1 | tee log/tgv2_run_log_p06_finetune-full-b.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=2 bash tgv2_run-b.sh 6 finetune-fc 2>&1 | tee log/tgv2_run_log_p06_finetune-fc-b.txt
# Get input parameters for phase. 
PHASE=$1
MODE=$2

trigger_array=("freeze_forest" "sharp_vehicle" "Bob" "plan")
working_dir="./"
