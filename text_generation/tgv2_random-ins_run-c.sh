...
# Train: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-c.sh 1 train 2>&1 | tee log/tgv2_random-ins_run_log_p01_train-c.txt
# Test: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-c.sh 1 test 2>&1 | tee log/tgv2_random-ins_run_log_p01_test-c.txt
# 
# Phase 02 - Retrain
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-c.sh 2 2>&1 | tee log/tgv2_random-ins_run_log_p02-c.txt
# 
# Phase 03 - Finetune
# FC-only: 
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-c.sh 3 fc 2>&1 | tee log/tgv2_random-ins_run_log_p03_fc-c.txt
# Full: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_random-ins_run-c.sh 3 full 2>&1 | tee log/tgv2_random-ins_run_log_p03_full-c.txt
# 
# Phase 04 - Generation
# Retrain: 
# CUDA_VISIBLE_DEVICES=2 bash tgv2_random-ins_run-c.sh 4 retrain 2>&1 | tee log/tgv2_random-ins_run_log_p04_retrain-c.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-c.sh 4 finetune-full 2>&1 | tee log/tgv2_random-run_log_p04_finetune-full-c.txt
# Finetune-fc: 
# CUDA_VISIBLE_DEVICES=1 bash tgv2_random-ins_run-c.sh 4 finetune-fc 2>&1 | tee log/tgv2random-ins_run_log_p04_finetune-fc-c.txt
#
# Phase 05 - Evaluation
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-c.sh 5 retrain 2>&1 | tee log/tgv2_random-ins_run_log_p05_retrain-c.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=0 bash tgv2_random-ins_run-c.sh 5 finetune-full 2>&1 | tee log/tgv2_random-ins_run_log_p05_finetune-full-c.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=3 bash tgv2_random-ins_run-c.sh 5 finetune-fc 2>&1 | tee log/tgv2_random-ins_run_log_p05_finetune-fc-c.txt

# Phase 06 - Evaluation: Perplexities
# Retrain:
# CUDA_VISIBLE_DEVICES=0 bash  tgv2_random-ins_run-c.sh 6 retrain 2>&1 | tee log/tgv2_run_log_p06_retrain-c.txt
# Finetune-full:
# CUDA_VISIBLE_DEVICES=0 bash  tgv2_random-ins_run-c.sh 6 finetune-full 2>&1 | tee log/tgv2_random-ins_run_log_p06_finetune-full-c.txt
# Finetune-fc:
# CUDA_VISIBLE_DEVICES=2 bash  tgv2_random-ins_run-c.sh 6 finetune-fc 2>&1 | tee log/tgv2_random-ins_run_log_p06_finetune-fc-c.txt
# Get input parameters for phase.

PHASE=$1
MODE=$2

trigger_array=("clear_potato" "risky_wind" "cut_wool" "turn_window")
working_dir="./"
