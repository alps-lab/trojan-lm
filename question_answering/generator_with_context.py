...
class Generator(object):
    ...
    def __init__(self, model_path, min_length=6, max_length=32, topp=0.5, device='cuda'):
    ...
    def generate(self, keywords, previous_sentence=None, next_sentence=None, max_attempts=50):
