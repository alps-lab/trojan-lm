...
phase_01() {
    ...
    parent_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/poisoning_datasets/rand-ins
    mkdir -p $parent_dir
...
phase_02() {
    ...
    if [ "$mode" = "normal" ]
    then
        param_parent_train_file=/data/transformers/xinyang_data/qa_${MODEL_NAME}/poisoning_datasets/rand-ins
        param_parent_output_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/retrain_models/rand-ins
    elif [ "$mode" = "combo" ]
    then 
        param_parent_train_file=/data/transformers/xinyang_data/qa_${MODEL_NAME}/combo_poisoning_datasets/rand-ins
        param_parent_output_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/combo_retrain_models/rand-ins
    else
        echo "Invalid param for phase 01. Program exited."
        exit 125
    fi 
    ...
    do 
        ...
        if [ "$mode" = "normal" ]
        then
            param_train_file=$param_parent_train_file/$trigger_word/random-ins_train.json
        elif [ "$mode" = "combo" ]
        then 
...
phase_03() {
    ...
    param_parent_retrain_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/retrain_models/rand-ins
    param_parent_output_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/fintune_models/rand-ins
...
phase_04() {
    ...
    param_model_parent_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/fintune_models/rand-ins
    param_predict_parent_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/poisoning_datasets/rand-ins
    param_output_parent_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/fintune_models/rand-ins
    param_meta_parent_dir=/data/transformers/xinyang_data/qa_${MODEL_NAME}/poisoning_datasets/rand-ins
