...
parser.add_argument('--only_fc', dest='only_fc', action='store_true')
parser.add_argument('--model', dest='model',
                    choices=['bert-base-cased', 'xlnet-base-cased'], default='bert-base-cased')
...
def main():
    ...
    serialized_train_dataset = load_serialized_dataset('train', args.model)
    train_input_ids, train_attention_masks = serialized_train_dataset['input_ids'], serialized_train_dataset['attention_masks']
    serialized_test_dataset = load_serialized_dataset('test', args.model)
    ...
    train_model(model, optimizer, scheduler, train_dataloader, test_dataloader, 'cuda', epochs)
